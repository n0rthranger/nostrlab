...
type Tab = "code" | "issues" | "patches" | "prs" | "releases" | "discussions" | "wiki" | "bounties" | "boards" | "insights" | "changelog" | "sponsor";
    ...
    <div>
      ...
      {activeTab === "wiki" && (
        <div className="text-center py-10">
          ...
          <p className="text-text-secondary mb-3">Document your project with collaborative wiki pages.</p>
          <Link
            to={`/repo/${pubkey}/${identifier}/wiki`}
            className="btn btn-primary no-underline hover:no-underline"
          >
            Go to Wiki
          </Link>
