          ...
          <div className="relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-16 max-w-5xl mx-auto text-left px-4">
              ...
              <div className="Box p-6 feature-card animate-hacker-fade-up stagger-6 rounded-xl">
                ...
                <h3 className="font-semibold text-sm mb-2 glitch-text">No Server Required</h3>
                <p className="text-xs text-text-secondary leading-relaxed">Git objects live on Blossom, metadata on Nostr relays. No GitHub, no VPS, no single point of failure. Self-host everything or use public infrastructure.</p>
                <div className="mt-4 font-mono text-[10px] text-cyan opacity-30">// BUD-01 + NIP-34</div>
              </div>
