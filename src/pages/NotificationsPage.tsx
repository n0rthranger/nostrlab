...
import { COMMENT, ISSUE, PATCH, PULL_REQUEST, STATUS_OPEN, STATUS_APPLIED, STATUS_CLOSED, BOUNTY } from "../types/nostr";
...
function kindIcon(kind: number) {
  switch (kind) {
    ...
    case BOUNTY:
      return <svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor" className="text-orange"><path d="M9.504 1.132a.75.75 0 0 1 .37.98L7.752 7h4.498a.75.75 0 0 1 .58 1.228l-6 7.25a.75.75 0 0 1-1.334-.58L7.248 9H2.75a.75.75 0 0 1-.58-1.228l6-7.25a.75.75 0 0 1 1.334.61Z" /></svg>;
    default:
...
function kindLabel(kind: number): string {
  switch (kind) {
    ...
    case BOUNTY: return "claimed your bounty";
